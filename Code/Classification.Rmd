...
The lakes polygons are obtained from the HydroLakes database, the waste management plants polygons are created in the following code, and the LDA model based on behaviour to differenciate agricultural fields and canals is trained on a trial dataset annotated by hand (see "Behaviour_analysis" code file).
